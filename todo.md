...
- [ ] Re-run full live role-surface verification and the frontend-only release guard only after every remaining legacy workspace presentation structure is replaced.
