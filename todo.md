...
- [ ] Verify the redesigned role workspaces at desktop and mobile widths, preserve working interactions and accessibility, run regression/type/build checks, and release only through GitHub and Vercel.
