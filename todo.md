...
- [ ] Execute and record one complete cross-role demonstration: Superadmin organization governance and invitation, Fleet Manager vehicle/component/work-order dispatch, Driver vehicle assignment and odometer/safety reporting, Mechanic or Technician repair execution, Inventory Manager part/vendor/purchase-order control, Accountant financial/reconciliation visibility, and Superadmin governance closeout.
...
- [ ] Verify the isolated Superadmin governance-closeout session using the already-controlled test sign-in detail; three non-sensitive role-alias variants were rejected, so do not retrieve credentials or alter tenant records.
...
- [ ] Produce one smooth narrated and captioned VahanSync end-to-end workflow video from the recorded real role workflows, then obtain approval before replacing the interim landing-page preview.
