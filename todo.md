...
- [ ] Diagnose the existing Accountant approval-queue load failure separately from the frontend redesign; do not hide or fabricate approval data while preserving the working Accountant ledger, reconciliation, exports, and financial-entry surface.
...
- [ ] Validate and release the public frontend replacement through the frontend-only release guard, GitHub, and Vercel before beginning the separate Accountant approval-queue root-cause investigation.
