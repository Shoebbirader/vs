...
- [ ] Replace the remaining Driver and Mechanic execution workspace JSX structure with new field-ready and repair-handoff composition while retaining every existing handler, query, mutation, draft, upload, and role restriction.
- [ ] Replace the remaining Inventory Manager and Accountant JSX structure with new stock-control and finance-close composition while retaining every existing query, mutation, ledger, purchase-order, reconciliation, and export behavior.
