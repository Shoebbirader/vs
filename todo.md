...
- [ ] Add regression coverage that signs out and re-authenticates an invited role account, then deploy and verify the production correction through GitHub and Vercel.
