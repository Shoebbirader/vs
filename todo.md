...
- [ ] Prevent the role route guard from falling through to an unauthenticated workspace render when the first post-invitation dashboard summary has a transient authorization error; preserve the fresh Supabase session and show bounded recovery state.
