...
- [ ] Replace the current authenticated frontend component layer from the ground up while keeping every existing tRPC call signature, Supabase Auth flow, RBAC boundary, backend procedure, database schema and record, migration, environment variable, and live workflow unchanged.
