...
- [ ] Add a frontend replacement contract baseline that proves no server, database, Supabase configuration, or authentication source file changes are included in the redesign release.
...
- [ ] Replace the remaining Superadmin, Team, notification, and shared resource-workspace JSX structure with new governance and resource-control composition while retaining existing frontend contracts and role boundaries.
