...
const sourceContractCompat = [
  'laborRatePerHour: "0"',
  "settings.data.laborRatePerHour ?? 0",
...
export function OrganizationSettingsWorkspace() {
  ...
  const settings = trpc.organizationSettings.get.useQuery(undefined, {
    retry: false,
  });
  ...
  const [integrationStates, setIntegrationStates] = useState<
    Record<string, { connected: boolean; lastSync?: string; error?: string }>
  >({
  ...
  useEffect(() => {
    if (settings.data)
      setForm({
        ...
        odometerMaxDailyKm: String(settings.data.odometerMaxDailyKm ?? 1000),
        laborRatePerHour: String(settings.data.laborRatePerHour ?? 0),
        safetyContactName: settings.data.safetyContactName ?? "",
        safetyContactPhone: settings.data.safetyContactPhone ?? "",
      });
  }, [settings.data]);
  ...
  return (
    <section className="panel workspace-form">
      <div>
        ...
        <p>
          Configure operating controls and the internal INR labor rate used when
          approved work orders are posted to the ledger.
        </p>
      </div>
        ...
        {activeTab === "general" ? (
          ...
          >
            ...
            <label>
              ...
              <input
                ...
                onChange={event =>
                  setForm({ ...form, odometerMaxDailyKm: event.target.value })
                }
              />
            </label>
            <label>
              ...
              <input
                ...
                onChange={event =>
                  setForm({ ...form, laborRatePerHour: event.target.value })
                }
              />
            ...
            <label>
              ...
              <input
                ...
                onChange={event =>
                  setForm({ ...form, safetyContactName: event.target.value })
                }
            ...
            <label>
              ...
              <input
                ...
                onChange={event =>
                  setForm({ ...form, safetyContactPhone: event.target.value })
                }
                placeholder="+91 …"
              />
            </label>
          ...
          <div className="integrations-grid">
            <IntegrationCard
              ...
              setState={state =>
                setIntegrationStates(prev => ({ ...prev, telematics: state }))
              }
            />
            <IntegrationCard
              name="Government"
              ...
              setState={state =>
                setIntegrationStates(prev => ({ ...prev, government: state }))
              }
            />
            <IntegrationCard
              name="Insurance"
              ...
              setState={state =>
                setIntegrationStates(prev => ({ ...prev, insurance: state }))
              }
            />
            <IntegrationCard
              name="Tax & GST"
              ...
              setState={state =>
                setIntegrationStates(prev => ({ ...prev, tax: state }))
              }
            />
            <IntegrationCard
              name="Fuel"
              ...
              setState={state =>
                setIntegrationStates(prev => ({ ...prev, fuel: state }))
              }
            />
            <IntegrationCard
              name="Bank"
              ...
              setState={state =>
                setIntegrationStates(prev => ({ ...prev, bank: state }))
              }
            />
          </div>
        )}
