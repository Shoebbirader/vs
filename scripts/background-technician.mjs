...
const ownerEmail = `vahansync.e2e.technician-owner.${runId}@example.com`;
const invitedEmail = `vahansync.e2e.technician.${runId}@example.com`;
const password = `VahanSyncTechnicianE2E!${runId}A`;
const results = [];
