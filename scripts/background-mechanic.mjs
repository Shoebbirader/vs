...
const ownerEmail = `vahansync.e2e.mechanic-owner.${runId}@example.com`;
const invitedEmail = `vahansync.e2e.mechanic.${runId}@example.com`;
const password = `VahanSyncMechanicE2E!${runId}A`;
const results = [];
