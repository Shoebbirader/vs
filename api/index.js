...
var vendors = (0, import_pg_core.pgTable)("vendors", { id: (0, import_pg_core.uuid)("id").defaultRandom().primaryKey(), orgId: (0, import_pg_core.uuid)("orgId").notNull(), name: (0, import_pg_core.text)("name").notNull(), contactPerson: (0, import_pg_core.text)("contactPerson"), phone: (0, import_pg_core.text)("phone").notNull(), email: (0, import_pg_core.text)("email"), ...audit });
